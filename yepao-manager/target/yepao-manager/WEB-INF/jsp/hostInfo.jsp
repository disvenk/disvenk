...
<html>
		...
		Date.prototype.format = function(format){ 
			...
			function doDelete(){
				...
				if(rows.length == 0){
					...
					//生成字符串
					var ids = arr.join(",");
					window.location.href = "/talent/delete?talent=host&ids="+ids;
				}
			}
	...
	<body class="easyui-layout" style="visibility:hidden;">
		...
		<div class="easyui-window" title="主持人修改" id="eidtorWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
			...
			<div region="center" style="overflow:auto;padding:5px;" border="false">
					<form id="updateForm" action="/talent/update?talent=host" method="post" enctype="multipart/form-data">
					<table class="table-edit" width="80%" height="80%" align="center">
						<tr class="title">
							<td colspan="2">人才信息</td>
