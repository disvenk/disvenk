...
<html>
	<head>
		...
		Date.prototype.format = function(format){ 
			...
			//其它移除按钮
			function otherFF(){
					$("#otherSelect option:selected").remove();	
			}
			//其它清空按钮
			function otherFFF(){
				$("#otherSelect").html("");
...
/* ------------------------------------------------------------------------------------------------------------------------------------------- */
			...
			//其它移除按钮
			function otherEFF(){
					$("#EotherSelect option:selected").remove();	
			}
			//其它清空按钮
			function otherEFFF(){
				$("#EotherSelect").html("");
				...
				<form id="addForm" action="/celebration/add" method="post" enctype="multipart/form-data">
					<table class="table-edit" width="80%" height="80%" align="center">
						...
						<tr>
							<td>司仪:</td>
							<td>
								<input type="text" name="host" class="easyui-validatebox" required="true" />
							</td>
						</tr>
						<tr>
							<td>化妆:</td>
							<td>
								<textarea name="dresser" class="easyui-validatebox" required="true" style="resize: none;width:40%;height:40px" rows="20"></textarea> 
							</td>
						</tr>
						<tr>
							<td>摄影:</td>
							<td>
								<textarea name="photograper" class="easyui-validatebox" required="true" style="resize: none;width:40%;height:40px" rows="20"></textarea> 
							</td>
						</tr>
							<tr>
							<td>其它:</td>
							<td>
								<input type="text" id="other" onkeydown="javascript:if(event.keyCode==13) otherF();" />
								<input type="button" onclick="otherF()" value="插入" />
								<input type="button" onclick="otherFF()" value="移除" />
								<input type="button" onclick="otherFFF()" value="清空" />
							</td>
						</tr>
						<tr>
						<td></td>
							<td>
								<select id="otherSelect" name="others" size="10" multiple="true" style="width:150px;"></select>
							</td>
						</tr>
						<tr>
							<td>迎宾区:</td>
				...
				<form id="updateForm" action="/celebration/update" method="post" enctype="multipart/form-data">
					<table class="table-edit" width="80%" height="80%" align="center">
						...
						<tr>
							...
							<td>其它:</td>
							<td>
								<input type="text" id="Eother" />
								<input type="button" onclick="otherEF()" value="插入" />
								<input type="button" onclick="otherEFF()" value="移除" />
								<input type="button" onclick="otherEFFF()" value="清空" />
								<input type="hidden" id="otherH" name="other" disabled="disabled"/>
							</td>
						</tr>
						<tr>
						<td></td>
							<td>
								<select id="EotherSelect" name="Eothers" size="10" multiple="true" style="width:150px;"></select>
							</td>
						</tr>
						<tr>
							<td>迎宾区:</td>
