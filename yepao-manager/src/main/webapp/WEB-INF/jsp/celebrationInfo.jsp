		...
		Date.prototype.format = function(format){ 
			...
			function stageHolographicF(){
				...
				if(stageHolographic!=""){
					...
					$("#stageHolographic").val("");
					$("#stageHolographic").focus();
				}
			}
			//其它移除按钮
			...
			<div region="center" style="overflow:auto;padding:5px;" border="false">
				<form id="addForm" action="/celebration/add" method="post" enctype="multipart/form-data">
					<table class="table-edit" width="80%" height="80%" align="center">
						...
						<td></td>
							<td>
								<select id="welcomeSelect" name="welcomes" size="10" multiple="true" style="width:250px;"></select>
							</td>
						</tr>
						<tr>
							<td>仪式区:</td>
						...
						<td></td>
							<td>
								<select id="ceremonySelect" name="ceremonys" size="10" multiple="true" style="width:250px;"></select>
							</td>
						</tr>
						<tr>
							<td>婚宴区:</td>
						...
						<td></td>
							<td>
								<select id="weddingSelect" name="weddings" size="10" multiple="true" style="width:250px;"></select>
							</td>
						</tr>
						<tr>
							<td>舞台灯光:</td>
						...
						<td></td>
							<td>
								<select id="deskLightSelect" name="deskLights" size="10" multiple="true" style="width:250px;"></select>
							</td>
						</tr>
						<tr>
							<td>舞台全息:</td>
						...
						<td></td>
							<td>
								<select id="stageHolographicSelect" name="stageHolographics" size="10" multiple="true" style="width:250px;"></select>
							</td>
						</tr>
						<tr>
							<td>备注</td>
			...
			<div region="center" style="overflow:auto;padding:5px;" border="false">
				<form id="updateForm" action="/celebration/update" method="post" enctype="multipart/form-data">
					<table class="table-edit" width="80%" height="80%" align="center">
						...
						<td></td>
							<td>
								<select id="EwelcomeSelect" name="Ewelcomes" size="10" multiple="true" style="width:250px;"></select>
							</td>
						</tr>
						<tr>
							<td>仪式区:</td>
						...
						<td></td>
							<td>
								<select id="EceremonySelect" name="Eceremonys" size="10" multiple="true" style="width:250px;"></select>
							</td>
						</tr>
						<tr>
							<td>婚宴区:</td>
						...
						<td></td>
							<td>
								<select id="EweddingSelect" name="Eweddings" size="10" multiple="true" style="width:250px;"></select>
							</td>
						</tr>
						<tr>
							<td>舞台灯光:</td>
						...
						<td></td>
							<td>
								<select id="EdeskLightSelect" name="EdeskLights" size="10" multiple="true" style="width:250px;"></select>
							</td>
						</tr>
