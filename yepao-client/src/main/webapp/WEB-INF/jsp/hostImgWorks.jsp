		...
		Date.prototype.format = function(format){ 
			...
			function doDelete(){
				...
				if(rows.length == 0){
					...
					//生成字符串
					var ids = arr.join(",");
					window.location.href = "/talentImgWorks/delete?talent=hostImg&ids="+ids;
				}
			}
			...
			$(function(){
				...
				$('#grid').datagrid( {
					...
					pagination : true,
					toolbar : toolbar,
					url : "/image_pageQuery?name="+encodeURI("主持人")+"&id="+$.cookie("checkHostId"),
