...
<html>
	<head>
		...
		function returnList(){
			$.cookie("checkComboId", null,{path:'/'});
			location.href="/pages/base/comboInfo";
		}
		...
		Date.prototype.format = function(format){ 
			...
			function doDelete(){
				...
				if(rows.length == 0){
					...
					//生成字符串
					var ids = arr.join(",");
					window.location.href = "/combo_comment/delete?ids="+ids;
				}
			}
			...
			$(function(){
				...
				$('#grid').datagrid( {
					...
					pagination : true,
					toolbar : toolbar,
					url : "/comboComment_pageQuery?comboId="+$.cookie("checkComboId"),
