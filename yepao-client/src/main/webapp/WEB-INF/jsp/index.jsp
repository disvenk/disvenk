		...
		var ws = null;
			$(function() {
			    ...
			    if ('WebSocket' in window) {
			         ws = new WebSocket('ws://192.168.1.18:9002/webSocketServer?userName='+userName); 
			         console.log("连接成功");
			    }
				...
				*/
				...
				window.setTimeout(function(){
					$.messager.show({
						title:"消息提示",
						msg:'欢迎登录，'+userName2+'！ <a href="javascript:void" onclick="top.showAbout();">联系管理员</a>',
						timeout:5000
					});
				},3000);
