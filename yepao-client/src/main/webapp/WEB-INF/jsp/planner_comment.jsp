...
<html>
	<head>
		...
		function returnList(){
			$.cookie("checkPlannerId", null,{path:'/'});
		...
		Date.prototype.format = function(format){ 
			...
			function doDelete(){
				...
				if(rows.length == 0){
					...
					//生成字符串
					var ids = arr.join(",");
					window.location.href = "/talent_comment/delete?talent=planner&ids="+ids;
				}
			}
			...
			$(function(){
				...
				$('#grid').datagrid( {
					...
					pagination : true,
					toolbar : toolbar,
					url : "/talentComment_pageQuery?talentId="+$.cookie("checkPlannerId"),
