...
<div style="padding:10px;">
	<table class="easyui-datagrid" id="item2List" style="height:auto;overflow:auto" data-options="singleSelect:false,collapsible:true,url:'/prepay/orderAlert',method:'post',toolbar:toolbar">
		<thead>
			<tr>
				...
				<th data-options="field:'gender',align:'center'">称谓</th>
				<th data-options="field:'tel',align:'center'">联系方式</th>
				<th data-options="field:'prepayed',align:'center',formatter:TAOTAO.formatDateTime">付款时间</th>
...
var toolbar = [{
    ...
    handler:function(){
    	...
    	$.messager.confirm("确认提示","确认后您将不再看到这条订单记录,只能在订单管理中查看,是否确认?", function(r){
    		if(r){
    			$.post("/editor/preChecked",{ids:ids},function(data){
    				if(data.status==200){
