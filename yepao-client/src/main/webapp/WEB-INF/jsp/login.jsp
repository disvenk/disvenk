	...
	<head>
		...
		<script type="text/javascript">	
		 ...
		 function login() {
				...
				var hotelId=$("#idInput").val();
				if(!(/^1(3|4|5|7|8)\d{9}$/.test(hotelId))){
					$("#alert").html("用户名格式有误");  
			        return false; 
				}
			...
			$.post("/login", $("#loginform").serialize(),function(data){
				...
				if (data.status == 200) {
					$.cookie("yonghuming", $("#idInput").val(), {expires:1,path:"/"})
				...
				<div class="col-md-4 col-md-offset-7 logincontent">
					...
					<form class="form-horizontal" id="loginform" name="loginform" 
						...
						<div class="form-group" id="idInputLine">
							...
							<div class="col-sm-8">
								<input id="idInput" type="text" name="hotelId" value="${cookie.username.value}" class="form-control" onkeydown="javascript:if(event.keyCode==13) login();" placeholder="请输入用户名">
							</div>
						</div>
